...
export default function Footer(){
    return (
    <div id='footer' className={styled.footer}>
      <div className={styled.footer_div1}>
        ...
        <h5><a href="https://wa.me/919848963748" target="_blank" rel="noreferrer">Developer Contact</a></h5>
      </div>
